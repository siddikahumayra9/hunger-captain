...
Check out [FRONTEND LIVE DEMO](https://hunger-captain-frontend.siddikahumayra9.repl.co/) here!!

Check out [API LIVE DEMO](https://hunger-captain-backend.siddikahumayra9.repl.co/) here!!
...
1. Git Clone https://github.com/siddikahumayra9/hunger-captain.git
